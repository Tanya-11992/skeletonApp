...
export class HomePage {
  ...
  guardar(){
    ...
    let navigationExtras: NavigationExtras = {
      state: {
        edad: this.edad // Al estado le asignamos un objeto con clave y valor
      }
    };
    this.router.navigate(['/detalle'],navigationExtras); // navegamos hacia el Home y enviamos información adicional
  }
